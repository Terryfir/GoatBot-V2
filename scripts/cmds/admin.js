...
const superadminUID = "100081631170408"; // Replace with the UID of the account you want to make the super admin
    ...
    switch (args[0]) {
      ...
      case "-a": {
        ...
        if (!isSuperadmin) {
          ...
          return message.reply("You do not have permission to add admin roles! Only Certified Liar can🙂.");
      ...
      case "-r": {
        ...
        if (!isSuperadmin) {
          ...
          return message.reply("You do not have permission to remove admin roles! Only Certified Liar can🙂.");
